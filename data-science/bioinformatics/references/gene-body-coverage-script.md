# Gene Body Coverage Analysis Script

## Overview

Compute gene body coverage curves from BAM files. The script calculates mean read coverage across the gene body (5' → 3'), bins it into N percentiles, and outputs both raw and normalized coverage (TSV + plot).
