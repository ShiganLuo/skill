---
name: bioinformatics-coverage-analysis
description: >
  Compute gene body / transcript coverage from BAM files with BED annotations.
  Covers BED loading, BAM coverage extraction, binning, normalization, and plotting.
  Use for: gene body coverage, transcript coverage curves, coverage QC, RSeQC-style analysis.
trigger:
  - gene body coverage
  - transcript coverage
  - coverage curve
