...
description: "Diagnose and fix Linux WiFi issues — networks not visible, 5GHz missing, regulatory domain problems, ath12k/ath11k/iwlwifi driver quirks. Covers self-managed vs kernel-managed regulatory, iw/nmcli diagnostics, modprobe fixes, and firmware issues."
tags: [linux, wifi, wireless, regulatory, ath12k, nmcli, iw, driver, troubleshooting]
related_skills: [linux-audio-troubleshooting]
---
