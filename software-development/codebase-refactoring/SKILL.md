...
description: "Refactor Python codebases: code quality review, file renaming to snake_case, import updates, and git workflow for restructuring projects."
triggers:
  - "review this code"
...
```
# Create renaming plan with old -> new mapping
