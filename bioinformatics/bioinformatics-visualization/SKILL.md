...
description: Build Python CLI tools for genomics SV visualization — OncoPrint, comparison bar charts, significance brackets, multi-format output.
triggers:
  - oncoprint
  - SV comparison plot
